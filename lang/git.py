...
ctx.keymap(
    {
        ...
        PREFIX + "diff over [<dgndictation>]": ["git diff ", text],
        PREFIX + "diff": ["git diff ", Key('enter')],
        PREFIX + "diff staged": ["git diff --staged ", Key('enter')],
